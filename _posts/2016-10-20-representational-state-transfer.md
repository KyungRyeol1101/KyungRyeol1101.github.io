...
정리하자면, @Controller의 주 용도는 view(화면)을 return하는 것이고, @RestController는 데이터를 return하는 것이 주 용도라고 할 수 있다. 물론, @Controller의 경우 method에 @ResponseBody를 사용하여 객체를 return 할 수도 있다.
